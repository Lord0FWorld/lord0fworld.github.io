...
$(document).ready(function(){$(".toggle_mnu").click(function(){$(".sandwich").toggleClass("active")}),$(".top_mnu li a").click(function(){$(".top_mnu").fadeOut(600),$(".sandwich").toggleClass("active")}).append("<span>"),$(".toggle_mnu").click(function(){$(".top_mnu").is(":visible")?($(".top_mnu").fadeOut(600),$(".top_mnu li a").removeClass("fadeInUp animated")):($(".top_mnu").fadeIn(600),$(".top_mnu li a").addClass("fadeInUp animated"))}),$(".top_mnu li a").mPageScroll2id(),$(".owl-carousel").owlCarousel({items:1,loop:!0,nav:!0,dots:!0,mouseDrag:!1,navContainerClass:"nav-wrap",navText:['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>']}),$(".next").on("click",function(){owl.trigger("next.owl.carousel",[500])}),$(".prev").on("click",function(){owl.trigger("prev.owl.carousel",[500])}),$(".tab_item").not(":first").hide(),$(".tab").click(function(){$(".tab").removeClass("active").eq($(this).index()).addClass("active"),$(".tab_item").hide().eq($(this).index()).fadeIn()}).eq(0).addClass("active"),$(".tab_item1").not(":first").hide(),$(".tab1").click(function(){$(".tab1").removeClass("active").eq($(this).index()).addClass("active"),$(".tab_item1").hide().eq($(this).index()).fadeIn()}).eq(0).addClass("active")});